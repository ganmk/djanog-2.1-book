    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookId', models.ForeignKey(to='main.Book',on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staffId', models.ForeignKey(to=settings.AUTH_USER_MODEL,on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userId', models.ForeignKey(to=settings.AUTH_USER_MODEL,on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='staffId',
            field=models.ForeignKey(to='main.StaffInfo',on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='borrowitem',
            name='userId',
            field=models.ForeignKey(to='main.UserInfo',on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='book',
            name='bookType',
            field=models.ForeignKey(to='main.BookType',on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='additem',
            name='bookId',
            field=models.ForeignKey(to='main.Book',on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='additem',
