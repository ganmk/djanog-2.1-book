...
class idd_country(models.Model):
    country_code = models.CharField(max_length=2, primary_key=True)
    country_cnname = models.CharField(max_length=25)
    country_enname = models.CharField(max_length=50)
    country_cnspell = models.CharField(max_length=50)
